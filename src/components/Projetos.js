  ...
  return (
    <>
      <section className='Proj' id="Proj">
        <h1>Projetos</h1>
        <p>Esses são alguns dos projetos pessoais realizados, <b>clique</b> em qualquer um deles para acessar a página com o código no github e link para acessar o site.</p>
